'''
Volatility adjusted momentum strategy (APO)

Same as reversion but we flip the buy/sell signals.

Note: there are some buy trades when APO signal values are negative and vice versa, this is to close out profitable positions.
'''
